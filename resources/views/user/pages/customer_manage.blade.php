                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="customerForm" method="POST"
                                                action="{{ route('user.customers.store') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <textarea class="form-control text-uppercase" id="addAddress" name="addAddress" rows="3" placeholder="E.G LEMONSITO (Address)"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <form id="transactionForm" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="addPrice"
                                                                    name="addPrice" required readonly />
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>LPD<small
                                                                    class="form-text text-muted"></label>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <!-- Delete Button -->
                                                        <form
                                                            action="{{ route('user.customers.destroy', $customer->id) }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.btn-add-customer, [data-bs-target="#addRowModal"]').click(function() {
                    ...
                    form.attr('action', '{{ route('user.customers.store') }}');
                ...
                $('.btn-edit-customer').click(function() {
                    ...
                    form.attr('action', '/user/customers/' + customerId);
            ...
            $('.btn-payment').click(function() {
                ...
                // Get customer info
                $.ajax({
                    url: '/user/customers/' + customerId + '/payment-info',
                    type: 'GET',
                    success: function(response) {
                        ...
                        $.getJSON('/user/customers/new-receipt', function(data) {
        ...
        <script>
            $(document).ready(function() {
                $('#transactionForm').submit(function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('user.customers.storeTransaction') }}",
                        type: 'POST',
                        data: formData,
                        processData: false,
                        contentType: false,
