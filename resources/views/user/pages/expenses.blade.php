                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="expenseForm" method="POST"
                                                action="{{ route('user.expenses.store') }}" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        @foreach ($expenses as $expense)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <!-- Delete Button --> --}}
                                                    <form action="{{ route('user.expenses.destroy', $expense->id) }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.btn-add-expense').click(function() {
                    ...
                    $('#expenseForm').attr('action', "{{ route('user.expenses.store') }}");
                ...
                $('.btn-edit-expense').click(function() {
                    ...
                    $('#expenseForm').attr('action', '/user/expenses/' + id);
