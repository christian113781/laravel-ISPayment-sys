                                        ...
                                        @foreach ($plans as $plan)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('admin.customers.plans.destroy', $plan->id) }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.btn-add-plan').click(function() {
                    ...
                    $('#planForm').attr('action', "{{ route('admin.customers.plans.store') }}");
                ...
                $('.btn-edit-plan').click(function() {
                    ...
                    $('#planForm').attr('action', '/admin/plans/' + id); // update route
