                                        ...
                                        @foreach ($areas as $area)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('admin.customers.areas.destroy', $area->id) }}"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.btn-add-area').click(function() {
                    ...
                    $('#areaForm').attr('action', "{{ route('admin.customers.areas.store') }}");
                ...
                $('.btn-edit-area').click(function() {
                    ...
                    $('#areaForm').attr('action', '/admin/areas/' + id); // update route
