...
class AdminAppController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.dashboard', compact('totalExpensesSales','currentExpensesMonthIncome','customerMonthlySales','vendoMonthlySales','expensesMonthlySales', 'totalCustomers','totalVendos', 'currentCustomerMonthIncome','currentVendoMonthIncome','totalCustomerSales','totalVendoSales'));
    }
